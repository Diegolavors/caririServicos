            ...
            <div class="row">
                <div class="col-xs-12 col-lg-10 col-lg-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" class="form-control" name="Sexo" id="Sexo" value="1" required=""/>Masculino
                        <input type="radio" class="form-control" name="Sexo" id="Sexo" value="2" required=""/>Feminino
                        <input type="radio" class="form-control" name="Sexo" id="Sexo" value="3" required=""/>Outros
                    </div>
                    <div class="form-group">
